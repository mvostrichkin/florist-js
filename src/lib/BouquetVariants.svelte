<script>
  ...
  <div style="float:left;background:white;border: solid 1px #c9aeeb;margin: 8px;border-radius:20px;padding:16px;box-shadow: 4px 4px 16px 0 #d7cfe9;border:solid 1px #cdafe4">
    <img src="{getImgUrl()}" alt="Фото" class="bouquetImg">
    <span style="margin:16px -16px ;display:block;padding: 16px 16px 8px;border-bottom: dotted 4px #cdafe4"><span class="text-xl font-bold" style="color:#4c2282">{variantsData.variant[0]}</span></span><br>
